...
type UsageEventsData struct {
	...
	TotalFwUpdates NullableInt64 `json:"total_fw_updates,omitempty"`
	// Number of device reboots in this period (from _health.qo boot events)
	TotalReboots NullableInt64 `json:"total_reboots,omitempty"`
...
// GetTotalFwUpdates returns the TotalFwUpdates field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UsageEventsData) GetTotalFwUpdates() int64 {
	if o == nil || IsNil(o.TotalFwUpdates.Get()) {
		var ret int64
		return ret
	}
	return *o.TotalFwUpdates.Get()
}

// GetTotalFwUpdatesOk returns a tuple with the TotalFwUpdates field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetTotalFwUpdates gets a reference to the given NullableInt64 and assigns it to the TotalFwUpdates field.
func (o *UsageEventsData) SetTotalFwUpdates(v int64) {
	o.TotalFwUpdates.Set(&v)
}

// SetTotalFwUpdatesNil sets the value for TotalFwUpdates to be an explicit nil
func (o *UsageEventsData) SetTotalFwUpdatesNil() {
	o.TotalFwUpdates.Set(nil)
}
...
func (o *UsageEventsData) UnsetTotalFwUpdates() {
	o.TotalFwUpdates.Unset()
}

// GetTotalReboots returns the TotalReboots field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UsageEventsData) GetTotalReboots() int64 {
	if o == nil || IsNil(o.TotalReboots.Get()) {
		var ret int64
		return ret
	}
	return *o.TotalReboots.Get()
}

// GetTotalRebootsOk returns a tuple with the TotalReboots field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetTotalReboots gets a reference to the given NullableInt64 and assigns it to the TotalReboots field.
func (o *UsageEventsData) SetTotalReboots(v int64) {
	o.TotalReboots.Set(&v)
}

// SetTotalRebootsNil sets the value for TotalReboots to be an explicit nil
func (o *UsageEventsData) SetTotalRebootsNil() {
	o.TotalReboots.Set(nil)
}
...
func (o UsageEventsData) ToMap() (map[string]interface{}, error) {
	...
	if o.TotalFwUpdates.IsSet() {
		toSerialize["total_fw_updates"] = o.TotalFwUpdates.Get()
	}
	if o.TotalReboots.IsSet() {
		toSerialize["total_reboots"] = o.TotalReboots.Get()
	}
...
func (o *UsageEventsData) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UsageEventsData(varUsageEventsData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "total_fw_updates")
		delete(additionalProperties, "total_reboots")
