...
| ------------------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **AggregateFunction**     | Pointer to **string**                                                  | Aggregate function to apply to the selected values before applying the condition. [none, avg, max, min, sum, count]                                                                                                                                               | [optional]                                                                                                      |
...
| **ConditionType**         | Pointer to **string**                                                  | A comparison operation to apply to the value selected by the source_selector. Required for event and usage monitors; set automatically for heartbeat monitors. [greater_than, greater_than_or_equal_to, less_than, less_than_or_equal_to, equal_to, not_equal_to] | [optional]                                                                                                      |
...
| **SourceSelector**        | Pointer to **string**                                                  | A dot-delimited path to a single numeric value within the event body.                                                                                                                                                                                             | [optional]                                                                                                      |
| **SourceType**            | Pointer to **string**                                                  | The type of source to monitor. Defaults to \&quot;event\&quot;.                                                                                                                                                                                                   | [optional] [default to "event"]                                                                                 |
| **Threshold**             | Pointer to **int32**                                                   | The value that condition_type compares against. For heartbeat monitors this is seconds of inactivity; for usage monitors it is bytes.                                                                                                                             | [optional]                                                                                                      |
